...
using System.Data;
namespace Denso_ORM_PLC_Service.Data_Layer
{
    public class DatabaseConnections
    {
        ...
        public bool Connect()
        {
            try
            {
                strSqlConn = "Data Source=" + Denso_ORM_PLC_Service.Entity_Layer.DatabaseSettings.SqldbServer + ";initial catalog=" + Denso_ORM_PLC_Service.Entity_Layer.DatabaseSettings.SqlDBName + "; Integrated Security=false;User ID=" + Denso_ORM_PLC_Service.Entity_Layer.DatabaseSettings.SqlDBUserID + ";PWD=" + Denso_ORM_PLC_Service.Entity_Layer.DatabaseSettings.SqlDBPassword;
