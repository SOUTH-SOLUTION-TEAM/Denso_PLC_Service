...
// Type: Denso_ORM_PLC_Service.Pages.Panel_9
...
{
    public partial class Panel_9 : Form
    {
        ...
        private bool strData = false;
                public Panel_9() => this.InitializeComponent();
        ...
        private void Panel_9_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-9) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_9");
            }
        }

        private void Panel_9_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
