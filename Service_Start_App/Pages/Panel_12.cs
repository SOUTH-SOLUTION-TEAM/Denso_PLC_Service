...
// Type: Denso_ORM_PLC_Service.Pages.Panel_12
...
{
    public partial class Panel_12 : Form
    {
        ...
        public Panel_12() => this.InitializeComponent();
        ...
        private void Panel_12_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-12) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_12");
            }
        }

        private void Panel_12_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
