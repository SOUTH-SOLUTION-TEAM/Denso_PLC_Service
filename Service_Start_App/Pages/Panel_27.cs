...
// Type: Denso_ORM_PLC_Service.Pages.Panel_27
...
{
    public partial class Panel_27 : Form
    {
        ...
        public Panel_27() => this.InitializeComponent();
        ...
        private void Panel_27_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-27) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_27");
            }
        }

        private void Panel_27_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
