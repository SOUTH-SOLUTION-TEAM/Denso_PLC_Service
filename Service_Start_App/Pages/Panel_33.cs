...
// Type: Denso_ORM_PLC_Service.Pages.Panel_33
...
{
    public partial class Panel_33 : Form
    {
        ...
        public Panel_33() => this.InitializeComponent();
        ...
        private void Panel_33_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-33) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_33");
            }
        }

        private void Panel_33_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
