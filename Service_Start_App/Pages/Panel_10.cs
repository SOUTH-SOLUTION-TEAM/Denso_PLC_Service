...
// Type: Denso_ORM_PLC_Service.Pages.Panel_10
...
{
    public partial class Panel_10 : Form
    {
        ...
        private void Panel_10_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text ="(P-10) "+ this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_10");
            }
        }

        private void Panel_10_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
