...
// Type: Denso_ORM_PLC_Service.Pages.Panel_16
...
{
    public partial class Panel_16 : Form
    {
        ...
        public Panel_16() => this.InitializeComponent();
        ...
        private void Panel_16_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-16) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_16");
            }
        }

        private void Panel_16_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
