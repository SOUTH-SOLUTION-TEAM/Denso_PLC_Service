...
// Type: Denso_ORM_PLC_Service.Pages.Panel_2
...
{
    public partial class Panel_2 : Form
    {
        ...
        public Panel_2() => this.InitializeComponent();
        ...
        private void Panel_2_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-2) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_1");
            }
        }
