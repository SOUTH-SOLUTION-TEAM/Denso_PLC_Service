...
// Type: Denso_ORM_PLC_Service.Pages.Panel_13
...
{
    public partial class Panel_13 : Form
    {
        ...
        public Panel_13() => this.InitializeComponent();
        ...
        private void Panel_13_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-13) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_13");
            }
        }

        private void Panel_13_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
