...
// Type: Denso_ORM_PLC_Service.Pages.Panel_15
...
{
    public partial class Panel_15 : Form
    {
        ...
        public Panel_15() => this.InitializeComponent();
        ...
        private void Panel_15_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-15) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_15");
            }
        }

        private void Panel_15_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
