...
// Type: Denso_ORM_PLC_Service.Pages.Panel_21
...
{
    public partial class Panel_21 : Form
    {
        ...
        public Panel_21() => this.InitializeComponent();
        ...
        private void Panel_21_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-21) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_21");
            }
        }

        private void Panel_21_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
