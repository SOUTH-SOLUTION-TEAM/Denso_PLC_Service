...
// Type: Denso_ORM_PLC_Service.Pages.Panel_3
...
{
    public partial class Panel_3 : Form
    {
        ...
        public Panel_3() => this.InitializeComponent();
        ...
        private void Panel_3_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-3) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_3");
            }
        }

        private void Panel_3_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
