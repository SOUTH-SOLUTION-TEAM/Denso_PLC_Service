...
// Type: Denso_ORM_PLC_Service.Pages.Panel_35
...
{
    public partial class Panel_35 : Form
    {
        ...
        public Panel_35() => this.InitializeComponent();
        ...
        private void Panel_35_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-35) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_35");
            }
        }

        private void Panel_35_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
