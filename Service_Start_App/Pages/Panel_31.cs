...
// Type: Denso_ORM_PLC_Service.Pages.Panel_31
...
{
    public partial class Panel_31 : Form
    {
        ...
        public Panel_31() => this.InitializeComponent();
        ...
        private void Panel_31_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-31) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_31");
            }
        }

        private void Panel_31_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
