...
// Type: Denso_ORM_PLC_Service.Pages.Panel_14
...
{
    public partial class Panel_14 : Form
    {
        ...
        public Panel_14() => this.InitializeComponent();
        ...
        private void Panel_14_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-14) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_14");
            }
        }

        private void Panel_14_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
