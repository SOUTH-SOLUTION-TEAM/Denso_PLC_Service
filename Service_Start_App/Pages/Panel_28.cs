...
// Type: Denso_ORM_PLC_Service.Pages.Panel_28
...
{
    public partial class Panel_28 : Form
    {
        ...
        public Panel_28() => this.InitializeComponent();
        ...
        private void Panel_28_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-28) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_28");
            }
        }

        private void Panel_28_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
