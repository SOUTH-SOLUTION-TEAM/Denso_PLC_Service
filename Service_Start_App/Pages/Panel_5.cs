...
// Type: Denso_ORM_PLC_Service.Pages.Panel_5
...
{
    public partial class Panel_5 : Form
    {
        ...
        public Panel_5() => this.InitializeComponent();
        ...
        private void Panel_5_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-5) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_5");
            }
        }

        private void Panel_5_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
