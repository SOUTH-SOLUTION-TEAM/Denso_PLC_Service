...
// Type: Denso_ORM_PLC_Service.Pages.Panel_8
...
{
    public partial class Panel_8 : Form
    {
        ...
        public Panel_8() => this.InitializeComponent();
        ...
        private void Panel_8_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-8) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_8");
            }
        }

        private void Panel_8_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
