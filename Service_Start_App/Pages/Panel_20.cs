...
// Type: Denso_ORM_PLC_Service.Pages.Panel_20
...
{
    public partial class Panel_20 : Form
    {
        ...
        public Panel_20() => this.InitializeComponent();
        ...
        private void Panel_20_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-20) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_20");
            }
        }

        private void Panel_20_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
