...
// Type: Denso_ORM_PLC_Service.Pages.Panel_7
...
{
    public partial class Panel_7 : Form
    {
        ...
        public Panel_7() => this.InitializeComponent();
        ...
        private void Panel_7_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-7) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_7");
            }
        }

        private void Panel_7_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
