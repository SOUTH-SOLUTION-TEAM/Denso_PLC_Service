...
// Type: Denso_ORM_PLC_Service.Pages.Panel_11
...
{
    public partial class Panel_11 : Form
    {
        ...
        public Panel_11() => this.InitializeComponent();
        ...
        private void Panel_11_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text ="(P-11) "+ this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_11");
            }
        }
        ...
        private void Panel_11_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
