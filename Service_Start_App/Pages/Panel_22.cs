...
// Type: Denso_ORM_PLC_Service.Pages.Panel_22
...
{
    public partial class Panel_22 : Form
    {
        ...
        public Panel_22() => this.InitializeComponent();
        ...
        private void Panel_22_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-22) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_22");
            }
        }

        private void Panel_22_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
