...
// Type: Denso_ORM_PLC_Service.Pages.Panel_36
...
{
    public partial class Panel_36 : Form
    {
        ...
        public Panel_36() => this.InitializeComponent();
        ...
        private void Panel_36_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-36) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_36");
            }
        }

        private void Panel_36_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
