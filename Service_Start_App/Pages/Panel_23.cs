...
// Type: Denso_ORM_PLC_Service.Pages.Panel_23
...
{
    public partial class Panel_23 : Form
    {
        ...
        public Panel_23() => this.InitializeComponent();
                        ...
                        try
                        {
                            ...
                            for (int index = 0; index < flagArray.Length; ++index)
                            {
                                if (flagArray[index] && !Result1[index])
                                {
                                    ...
                                    else if (CommonVariable.Result.Contains("Saved"))
                                    {

                                        string[] Result = CommonVariable.Result.Split('|');
                                        if (Result.Length > 0)
                                        {
                                            lblLineName.Text = "Hi ";
                                            ...
                                            {
                                                lblLineName.Text ="Hii "+ Result[1].ToString();
                                                Write(false, 19);
                                            }
                                            else if (Result[4]== "MAINTENANCE")
                                            {
                                                lblLineName.Text = Result[4].ToString();
                                                Write(true, 19);

                                            }
                                            else
                                            {
                                                lblLineName.Text ="Hiii ";
                                            }
                                        }
                                        //    string[] strArray = new string[6]
                                        //    {
        ...
        private void Panel_23_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-23) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_23");
            }
        }

        private void Panel_23_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
