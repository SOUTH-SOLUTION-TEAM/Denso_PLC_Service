...
// Type: Denso_ORM_PLC_Service.Pages.Panel_30
...
{
    public partial class Panel_30 : Form
    {
        ...
        public Panel_30() => this.InitializeComponent();
        ...
        private void Panel_30_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-30) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_30");
            }
        }

        private void Panel_30_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
