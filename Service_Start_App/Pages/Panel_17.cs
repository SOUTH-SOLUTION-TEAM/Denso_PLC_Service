...
// Type: Denso_ORM_PLC_Service.Pages.Panel_17
...
{
    public partial class Panel_17 : Form
    {
        ...
        public Panel_17() => this.InitializeComponent();
        ...
        private void Panel_17_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-17) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_17");
            }
        }

        private void Panel_17_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
