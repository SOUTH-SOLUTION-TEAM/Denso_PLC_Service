...
// Type: Denso_ORM_PLC_Service.Pages.Panel_6
...
{
    public partial class Panel_6 : Form
    {
        ...
        public Panel_6() => this.InitializeComponent();
        ...
        private void Panel_6_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-6) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_6");
            }
        }

        private void Panel_6_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
