...
// Type: Denso_ORM_PLC_Service.Pages.Panel_19
...
{
    public partial class Panel_19 : Form
    {
        ...
        public Panel_19() => this.InitializeComponent();
        ...
        private void Panel_19_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-19) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_19");
            }
        }

        private void Panel_19_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
