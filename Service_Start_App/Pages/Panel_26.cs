...
// Type: Denso_ORM_PLC_Service.Pages.Panel_26
...
{
    public partial class Panel_26 : Form
    {
        ...
        public Panel_26() => this.InitializeComponent();
        ...
        private void Panel_26_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-26) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_26");
            }
        }

        private void Panel_26_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
