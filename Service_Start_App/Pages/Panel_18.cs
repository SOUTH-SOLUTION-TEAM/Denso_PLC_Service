...
// Type: Denso_ORM_PLC_Service.Pages.Panel_18
...
{
    public partial class Panel_18 : Form
    {
        ...
        public Panel_18() => this.InitializeComponent();
        ...
        private void Panel_18_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-18) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_18");
            }
        }

        private void Panel_18_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
