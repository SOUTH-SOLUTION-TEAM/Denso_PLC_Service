...
// Type: Denso_ORM_PLC_Service.Pages.Panel_34
...
{
    public partial class Panel_34 : Form
    {
        ...
        public Panel_34() => this.InitializeComponent();
        ...
        private void Panel_34_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-34) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_34");
            }
        }

        private void Panel_34_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
