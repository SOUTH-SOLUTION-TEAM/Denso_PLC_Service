...
// Type: Denso_ORM_PLC_Service.Pages.Panel_4
...
{
    public partial class Panel_4 : Form
    {
        ...
        private bool strData = false;
         public Panel_4() => this.InitializeComponent();
        ...
        private void Panel_4_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-4) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_4");
            }
        }

        private void Panel_4_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
