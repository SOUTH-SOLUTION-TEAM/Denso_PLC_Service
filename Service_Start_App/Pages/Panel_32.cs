...
// Type: Denso_ORM_PLC_Service.Pages.Panel_32
...
{
    public partial class Panel_32 : Form
    {
        ...
        public Panel_32() => this.InitializeComponent();
        ...
        private void Panel_32_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-32) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_32");
            }
        }

        private void Panel_32_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
