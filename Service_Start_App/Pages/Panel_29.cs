...
// Type: Denso_ORM_PLC_Service.Pages.Panel_29
...
{
    public partial class Panel_29 : Form
    {
        ...
        public Panel_29() => this.InitializeComponent();
        ...
        private void Panel_29_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-29) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_29");
            }
        }

        private void Panel_29_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
