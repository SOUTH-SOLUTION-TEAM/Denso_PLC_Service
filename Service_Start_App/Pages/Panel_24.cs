...
// Type: Denso_ORM_PLC_Service.Pages.Panel_24
...
{
    public partial class Panel_24 : Form
    {
        ...
        public Panel_24() => this.InitializeComponent();
        ...
        private void Panel_24_Load(object sender, EventArgs e)
        {
            try
            {
                this.lblLineName.Text = "(P-24) " + this.LineName;
                this.Connect();
            }
            catch (Exception ex)
            {
                int num = (int)MessageBox.Show(ex.Message.ToString(), "PANEL_24");
            }
        }

        private void Panel_24_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
